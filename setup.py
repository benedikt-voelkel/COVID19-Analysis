...
setup(
  ...
  url='https://github.com/benedikt-voelkel/Covid19Analysis',
  author='Benedikt Voelkel',
  author_email='benedikt.voelkel@gmx.de',
  ...
  entry_points={
      "console_scripts": [ "covid19-analysis = covid19_analysis.run:main"]
  }
)
